    ...
    <nav className="bg-gray-900 border-gray-200">
      <div className="flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
          ...
          <span className="self-center text-2xl font-semibold whitespace-nowrap">MiniPainter</span>
        </a>
        {props.current_user &&
          <ProfilePicture
            width='35px'
            imageUrl={props.current_user_profile_picture_url}
            className='flex-1 ml-auto mr-2 max-w-[35px] md:hidden' />
        }
