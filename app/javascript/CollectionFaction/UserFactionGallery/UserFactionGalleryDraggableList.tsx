...
import UserFactionGalleryDraggableItem, { ProposedImage } from "./UserFactionGalleryDraggableItem";
...
const UserFactionGalleryDraggableList = (props: Props) => {
        ...
        <SortableContext items={images}>
          <ul>
            {images.map((image, index) => (
              <UserFactionGalleryDraggableItem
                key={image.id}
                image={image}
...
export default UserFactionGalleryDraggableList;
