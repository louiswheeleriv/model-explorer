...
const EditUserFactionGallery = (props: Props) => {
  ...
  async function saveImages() {
    apiCall({
      endpoint: '/my-collection/user-factions/'+props.userFaction.id+'/images',
      method: 'POST',
      body: {
      ...
      .then((body) => {
        if (body.status >= 300) {
          ...
          window.location.assign('/my-collection/user-factions/'+props.userFaction.id+'?mode=gallery');
        }
      });
  }
...
export default EditUserFactionGallery;
