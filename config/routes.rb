Rails.application.routes.draw do
  ...
  get 'my-collection/user-factions/:user_faction_id' => 'my_collection#show_faction'
  post 'my-collection/user-factions' => 'my_collection#add_faction'
  put 'my-collection/user-factions/:user_faction_id' => 'my_collection#update_user_faction'
  delete 'my-collection/user-factions/:user_faction_id' => 'my_collection#delete_user_faction'
  post 'my-collection/user-factions/:user_faction_id/user-models' => 'my_collection#add_user_model'
  put 'my-collection/user-factions/:user_faction_id/user-models/:user_model_id' => 'my_collection#edit_user_model'
  ...
  post 'my-collection/user-factions/:user_faction_id/images' => 'my_collection#set_user_faction_image_associations'
