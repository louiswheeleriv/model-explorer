Rails.application.routes.draw do
  ...
  put 'my-collection/factions/:user_faction_id' => 'my_collection#update_user_faction'
  delete 'my-collection/factions/:user_faction_id' => 'my_collection#delete_user_faction'
  post 'my-collection/factions/:user_faction_id/user-models' => 'my_collection#add_user_model'
  put 'my-collection/factions/:user_faction_id/user-models/:user_model_id' => 'my_collection#edit_user_model'
  delete 'my-collection/factions/:user_faction_id/user-models/:user_model_id' => 'my_collection#delete_user_model'
  post 'my-collection/factions/:user_faction_id/groups' => 'my_collection#set_user_model_groups'
