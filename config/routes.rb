Rails.application.routes.draw do
  ...
  put 'my_collection/factions/:faction_id/user_models/:user_model_id' => 'my_collection#edit_user_model'
  post 'my_collection/factions/:faction_id/groups' => 'my_collection#set_user_model_groups'
  get 'my_collection/:faction_name/user_models/:user_model_id' => 'my_collection#show_user_model'
